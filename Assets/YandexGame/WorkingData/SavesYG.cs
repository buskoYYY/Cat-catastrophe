...
namespace YG
{
    ...
    public class SavesYG
    {
        ...
        public void SetNewHighscore(int value)
        {
            HighScore += value;
        ...
        public static void SetInt(string key, int writeValue, bool important = false)
        {
            if (local_dictionary.Set(key, writeValue))
                YandexGame.savesData.Save(important);
        }
        ...
        public static void SetBool(string key, bool writeValue, bool important = false)
        {
            if (local_dictionary.Set(key, writeValue))
                YandexGame.savesData.Save(important);
        }
        ...
        public static void SetFloat(string key, float writeValue, bool important = false)
        {
            if (local_dictionary.Set(key, writeValue))
                YandexGame.savesData.Save(important);
        }
        ...
        public static void SetString(string key, string writeValue, bool important = false)
        {
        ...
        public static void DeleteKey(string key, bool important = false)
        {
            if (local_dictionary.ContainsKey(key))
        ...
        public static void DeleteAll(bool important = false)
        {
        ...
        public void Save(bool forceSave = false)
        {
            ...
            YandexGame.SaveProgress(forceSave);
        }
